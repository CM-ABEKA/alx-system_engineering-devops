...
-----
 ...
 ###  0. Use a private key 
  ...
  mandatory        Score: 0.0% (Checks completed: 0.0%)   Write a Bash script that uses `ssh` to connect to your server using the private key `~/.ssh/school` with the user `ubuntu`.
